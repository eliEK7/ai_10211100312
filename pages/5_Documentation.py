...
markdown_file_path = os.path.join("documentation.md")
image_placeholder = "![System Architecture Image](../data/architecture.png)"

# Direct Markdown content (copied from documentation.md)
markdown_content = """
# Documentation (LLM)
...
# Image path
image_path = "data/architecture.png"

# Render Markdown content
st.markdown(markdown_content)

# Check if the image exists and render
if os.path.exists(image_path):
    st.image(image_path, caption="System Architecture Image", use_container_width=True)
else:
    st.error(f"❌ Image not found at: {os.path.abspath(image_path)}")

# Continue the rest of your markdown content if needed
st.markdown("""
